#!/usr/bin/env python
"""
Package metadata for platform_plugin_forum_email_notifier.
"""
import os
import re
import sys
...
setup(
    name="platform-plugin-forum-email-notifier",
    version=VERSION,
    description="""Open edX Django plugin for email notifications of forum events.""",
    long_description=README + "\n\n" + CHANGELOG,
    author="eduNEXT",
    author_email="technical@edunext.co",
    url="https://github.com/eduNEXT/platform_plugin_forum_email_notifier",
